...
University of Leeds. Nicola Gambino is one of the leading researchers on Homotopy 
Type Theory:  his joint work with Richard Garner~\cite{gambinoGarner:ITwfs} 
obtained one of the first results relating  type theory and homotopy theory.
His expertise is directly relevant to the goals of the 
proposal: (1) his experience with constructive mathematics and homotopical algebra~\cite{GambinoN:homl2c,GambinoN:weilsh}
will be useful to study semantic models of HoTT in WP1; (2) his research on data
types~\cite{gambinoHyland:welfoundedTrees,GambinoN:polfpm}, and especially his 
recent work on inductive types in Homotopy Type Theory~\cite{awodeyGamSoja:indTypesInHTT}
links directly to our goals in WP2 on higher inductive types; (3) his experience in
proof theory and formalization of proofs in Coq will be beneficial for WP3, where we 
seek to develop meta-mathematics within HoTT.
...
has held visiting positions at leading research centres, including the Institut Mittag-Leffler (Stockholm), the
...
Institut Henri Poincar\'e (Paris) in occasion of the special trimester on

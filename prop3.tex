...
Curry-Howard correspondence which observed that programs and proofs
are actually the same thing, \eg proofs are just particular forms of
programs. As a result, by developing sophisticated type theories, we
advance both the fields of programming languages and program
...
Martin-L\"of Type Theory (MLTT).  However, 
this equality proved to be too weak, \eg functions that are pointwise
...
problem of a strong computational equality has remained
...
{\bf Observational Type Theory and Logical Relations:} (OTT) is a step
towards a stronger equality, proposed by Altenkirch and
McBride~\cite{alti:ott-conf}. Unlike the equality type of MLTT which

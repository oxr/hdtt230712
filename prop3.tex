...
Instead, we can program directly on the quotient algebra and
assert the correctness of the program within its type thereby 
efficiently formally verifying the program's correctness. Concretley, we will formalise both Lawvere
...
as it will be the first instance of formal verification in a {\em
  ...
  Formally verified proofs of the key properties of HoTT}

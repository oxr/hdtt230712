...
$\;\;\; \;\;\;$ {\em Theoretical Foundations.} Almost all of our understanding
  ...
  work by Bezem, Coquand and Huber~\cite{BezemM:cubsmt} strongly suggests a constructive presentation of HoTT
...
research aims to produce a formal verification system where objects
...
relations at higher types. Indeed the cubical sets model~\cite{BezemM:cubsmt} is closely related

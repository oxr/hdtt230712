...
in Paris and the Special Year on HoTT in Princeton.  Although the RA
will be expected to be able to work independently, our own strengths
means the RAs will be closely managed by the investigators. They will
be asked to work with the project partners and collaborators of the
investigators, to push the project ahead; to contribute to the writing
of papers and grant proposals; and, as part of their general training,
to help mentor PhD students. A Grade 7, Point 29 salary of
$\pounds$28,839 is the minimum for newly-minted PhDs, so a Grade 7,
Point 35 salary of $\pounds$35,597 will give us the flexibility to
employ the more senior RAs who have indicated their interest in
applying. The small extra cost is more than outweighed by the benefits
their greater breadth and depth that they bring to the project. The
balance of the team will be maintained by hiring one RA on WP1-4 at
Nottingham and one RA on WP5-8 at Strathclyde. However, we will expect
each to be conversant in the other's area and thus to be able to work
...
\end{document}
It is our view that the research programme outlined in the case for
support, with at least four distinct lines of attack, cannot
reasonably be accomplished mainly by one researcher, however
talented; in order to achieve the substantial and wide-ranging impacts
we hope for, we believe a second person working at 100 per cent time
is required.  We believe that having two RAs working on the same
project will have a multiplier effect due to the benefits of
collaboration, “team spirit” and cross-fertilisation between their
knowledge areas; so that the benefits will be greater than that of
having two RAs work on two separate projects.
...
The two RAs employed on this project will require access to good
quality computing facilities in order to develop and test the
automatic tools constructed as a fundamental part of this project, as
well as in the preparation of paper manuscripts and stan- dard tasks
such as email. Because we expect the two RAs to spend a considerable
proportion of their time in computationally demanding tasks — i.e.,
programming and testing tools for automatic pro- gram verification and
ancillary problems — it would be in our opinion of considerable
benefit for them to have access to dedicated desktop machines for
these tasks, in addition to a mobile computing capabil-
ity. Accordingly, we request two desktop computers at £1.5k each and
two laptop computers at £2k for the two RAs to be purchased at the
outset of the project. The laptop machines will be for use in home
working and on conference trips or other research visits away from the
office. The total re- quested spend on computers is £7k.  In addition,
we request £1.1k in total for such books, software licenses and
computer peripherals as become needed during the course of our
research programme. This has been costed as £500 in year 1 and £300 in
years 2 and 3.

%TXA M$ studentship. Appsem, Types
%TXA-Jes. obj, summary,acad ok. impact summary from p2i

%Katya HD HoTT difficult math for PL. We have a track record of
%redilding it!

%Whole > sum of parts. Each WPa small detailed step but collectively
%produce something new. 
%Why homotopty ... uniquely HD
%Why has no one done it before. Have we balls or insight

%Good research, someone will do it, we want to be the first.
%Everyone else ... mathemarticians wanting to formalise mathematics
%while we know both

%New Scientists. Decades ago ... ACM HoTT book
%Integrate letters of support.
%EPSRC, GMH, Katya, Mock panel
%Part of formal methods
%Pazzazz. pazzaz and unflashy hard work in quotes.
%% Insiders 
%Add quotables and fill space.
...
%Overeall: Excellent research, excellent people, excellent impact,
%important research
...
% Changyu
%We are ambitious people who want to
%change the world we live in and who believe we have the mathematical
%and comoputational tools to do exactly that. This project treads a
...
%Ian .. says who. Put HoTT Earlier? %New Scientist (Jes)
...
Prof Ghani, Dr Clemens Kupke, Dr Ross Duncan as well as two RAs and seven PhD students. The MSP group's vision is to use
...
in computer science is direct relevance to this project, \eg i) he has
...
which feed into WP2; ii) his work on data types (containers, quotient
containers, indexed
containers)~\cite{alti:mpc04,altenkirchGhaniHancockMcBrideMorris:indexedContainers}
feeds into WP3; iii) his work on
induction-induction~\cite{alti:cont-tcs,alti:catind2} feeds into the
formalisation of the syntax of type theory in WP5; and iv) his programming
language $\Pi\Sigma$~\cite{alti:pisigma-new} and feeds into WP6. He
...
structure) and extensional reasoning (proving programs with the same
...
lacked. The importance of HoTT can be seen from the ACM
including the HoTT book~\cite{hott-book} on its list of notable books
...
{\bf Type Theory.} Type theory underlyies formal verification systems and
...
which go beyond the usual tree-like data types --- while lists are an
...
Norell).  {\em Deliverable: Basic software tools for a high level
...
result, both EPSRC and the UK Grand Challenges in Computing both
...
between these projects.  Overall a succesful outcome is very realistic
...
success. Success criteria for each work package are given clear

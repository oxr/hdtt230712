...
%WP distinct. ??, Cubical TT, Contianers, Frank, HoTT in HoTT, ??, ??, UoM
...
%Higher homotopies and proof relevance.
...
% Changyu
%HD (semantically) = proof relevant (logically)
%constructivise simiplicail sets, VV
% PhD student at Nott and Strath.
%Hutton Advice
%Pazzazz. New Scientists. Decades ago ...
%OTT
%Ste : Colabs arre world leaders in the WP areas as explained in their
%letters.
...
categorical models of rewriting.  In 2008, he was appointed to a
...
current proposal, \eg i) his work on logical relations is directly
...
induction recursion) is directly related to WP3 which develops the
theory of higher inductive types; iii) his work on the semantics of
effects is directly related to the application of HoTT to effects in
...
Professor Ghani is a member of the EPSRC College charged with
assessing the quality of grant applications and a grant 
assessor for the Carnegie Trust. He is Deputy Head of department
and Head of Research in his home Department. He has successfully
supervised five PhD students and four RAs, organises the ScotCats
seminar series, and is organising the next UK HoTT meeting in January
2015, both of which puts him in touch with other experts in the
area. He has attracted £1.7M in research funding comprising £1.3M as
PI on 8 grants and \pounds 400K as CoI in 2 grants.  Indeed, results
obtained during his following EPSRC grants feed directly 
into this proposal: Theory And Applications of Induction Recursion
(EP/G03298X/1), Reusability and Dependent Types (EP/G034109/1),
Logical Relations for Program Verification (EP/K023837/1), and Theory
and Applications Of Containers (EP/C511964/2). Several of these are
multi-institutional grants similar in nature to this proposal
thereby demonstrate Professor Ghani's track record in succesfully
managing large distributed grants.


%He was the director of the Midlands
...
of non-dependently and dependently typed programming has become very
...
addresses at conferences etc. Taken with his experience implemetating Observational
Type Theory (a proof irrelevant form of HoTT), he is thus the ideal
person to lead WP6 and WP7. Furthermore, Dr McBride's work 
on containers and effects feed into WP3 and WP4 while his
...
(EP/C511964/2).  Altenkirch, Ghani and McBride have already collaborated
successfully on several research grants demonstrating their
...
homotopical algebra~\cite{GambinoN:homl2c,GambinoN:weilsh}. {\bf Space
  for one more line}
...
are many succesful approaches to software verification (\eg various
forms of testing, model checking etc) with the most rigorous offering
mathematical guarantees of the correctness of
software. However, the complexity of modern software means that
hand-written mathematical proofs are untrustworthy and this has led to
growing interest in machine-checked mathematical proofs of software
correctness. Several decades of pioneering work in the UK and
elsewhere has culminated in systems such as Agda, Coq, Epigram, Idris,
NuPRL, Twelf, and the Trellys project which are having significant
impact, \eg Coq won both the 2013 ACM Software award and the 2013
SIGPLAN Programming Languages Software award. Their advanced
type-theoretic technology is also exploited by more
...
$\;\;\;\;\;\;$ {\em Programming Language and Verification Tools.} The key
  ...
  cutting-edge developments in the foundations of type theory into state-of-the-art
  programming language and verification tools distinguishes us from 
  others who typically focus on one or the
  other. Indeed, as confirmed by our collaborators, we know of no
  other groups who share our ambition to construct HoTT-based programming languages and
  verification tools, and then apply them to specific case studies.
% We make this our goal as we believe that severing the link
%   between foundational understanding and practical application
%   diminishes both.
  This overall distinctiveness is complemented at a
  more detailed level by our ideas and results on logical relations,
  containers, observational type theory and cubical type theory which
  are core to our proposal. This
  is crucial --- while we benefit from being part of the worldwide
  HoTT community, we also have great distinctiveness in our cumulative
...
tools and demonstrate their value --- exactly what makes this proposal
distinctive from current research. 
...
%equational theories cannot be satisfactorially represented in current
%programming languages. Thus, 
...
other hand, we will push to achive the ambitious goal of {\bf formally
...
extremely timely: in addition to our own results, there have been
ground-breaking recent advances in HoTT, \eg the constructive cubical
sets model. Moreover, the US government has just funded a \$7.5m
complementary project applying HoTT to the foundations of mathematics,
thereby further increasing timeliness. We are {\em exceptionally

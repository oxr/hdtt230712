...
%Some constructions paper TXA OR
...
%No overstretch (POC)
%Collabs time
%cite UoM fibrations? cubical TT draft.
...
{\bf WP5 Formalisation of the Meta-Theory of HoTT.}  As we intend to
use HoTT as a formal verification system, the key properties of HoTT
must be formally verified. Indeed, as Voevodsky pointed out
...
formalisation of HoTT within itself. Therefore, WP5 will not only ensure the required level of trust in our
...
as we have begun formalising parts of HoTT~\cite{alti:csl12,}. Further, our

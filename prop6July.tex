...
% foundations of logical relations but also the applications to program
% verification. However, this would have been a mistake, as pointed out
% by Reviewer 13M7PG who states taht “One cannot reasonably expect
% direct industrial use on a broad scale of a proposal such as this, and
% if the authors proposed it, I would conclude their proposal lacks
% credibility. But they do not do that; and what they propose is
% delicate, eminently sensible, and practical.” We also believe that we
% have found the right balance of doing good foundational research on
% the one hand, and putting in place a robust mechanism for generating
% impact from that research on the other. Undertaking proof-of-concept
% case studies with various industrial collaborators is significantly
% more adventurous than a lot of proposed research. We do hope that this
% adventurousness will not be held against us because these case studies
% cannot be guaranteed to have massive and immediate industrial impact.

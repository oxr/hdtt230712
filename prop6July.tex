...
involve
axioms lacking computational justification, the recent
cubical sets model~\cite{BezemM:cubsmt,nominal} strongly suggests  that
HoTT has an axiom-free, and hence computational, presentation. We will
fundamentally transform the core of HoTT, namely its treatment of equality, via 
% a newv computational rendering of HoTT based on 
new constructive models
and complementary new type theories which
computationally justify all axioms (WP1,2,3).
...
programs containing axoims such as Univalence can be run.

...
relations~\cite{neil2014relParamDep} is directly related to 
the development of semantic and syntactic presentations of Homotopy
Type Theory (HoTT) in WP1,2; ii) his work on data types
...
is directly related to the development of higher inductive types in
WP3; iii) his work on the semantics of
...
collaboration with Microsoft) directly relates to HoTT-based computing
with algebraically indexed types in WP8. More generally, Neil Ghani is
a world expert on the use of semantic structures to drive the
...
nature to this proposal and their success demonstrates Ghani's track record in
...
Account demonstrates a track record of striving to generate impact from EPSRC
...
programming~\cite{viewftl,alti:ott-conf,easy,mcbride:outrageous}
...
thus the ideal person to lead WP5-7. Furthermore, Dr McBride's
...
of equality~\cite{altenkirch:extSetoids,alti:ott-conf,alti:csl12,alti:tlca13-hedberg},
...
him to obtain, in collaboration with Richard Garner, one of 
...
intricate higher dimensional structure which
%had not been understood until the development of HoTT.
we have so far not understood.
...
transform the foundations of programming, and we aim to leap ahead of
the field via the following synthesis of theoretical, applied, and
...
$\;\;\;\;\;\;$ {\em Programming Language and Verification Tools.} The key
  ...
  not just an end in itself, but is also a key prerequisite %opportunity 
...
systems. We will transform the area by producing a system where
...
research on logical relations will be used to inject advanced ideas from logical
relations, \eg higher dimensional logical relations, throughout
the project.
...
world-leading collaborators, and iii) the workshops we organise to
foster interaction. Additionally, each work package has its own
specific methodology, risk analysis, and a concrete and relatively
risk-free deliverable enabling the project to proceed.  Collectively,
these work packages will transform the foundations of programming and
formal verification.
...
all programs reduce. %to a normal form.  

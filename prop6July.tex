...
awards while HoL is used extensively by Intel~\cite{harrison:sfm,harisson:intel}. The technology
behind these
...
fundamental limitations, \eg when programming with quotient data-types (identifying objects up to some 
...
not just within the model. It would also be desirable to recover the definitional equalities lost by the cubical interpretation (such as
...
{\bf WP2: Univalent Type Theory.} On the basis of WP1, we will isolate the essential
structure of the constructive models of HoTT in the form of new type theories. The
challenge here is to present the relevant structure as built from
a {\em finite} collection of type and term constructors --- a 
particularly intricate task because of the  higher dimensional
structure of HoTT. These new type theories will enjoy the benefits of
HoTT but retain the essential properties of traditional type theories, such as strong normalisation, decidability of
definitional equality, and canonicity ({i.e.}~all terms reduce to
values). We will also establish the expressive
power of the associated equational theories, {e.g.}~by analyzing
carefully whether computation rules  hold as definitional
equalities or as propositional equalities. Another key property  (required for WP5) that our type theories
should have is that they should be expressive enough to describe their own models. This will be established either 

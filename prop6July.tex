...
is not enough to know when things are equal, but we must also know how
we proved such an equality. And then one needs to address the question
of when such proofs are equal! This leads to an intricate,

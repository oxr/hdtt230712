...
%is widely regarded as a breakthrough with the potential to solve 
these and other problems.
To realise this potential, we propose a synthesis of theoretical, applied, and impact-focussed research.

%We will use HoTT to transform the foundations of software
%construction and verification as follows:
...
%To realise this potential, we propose the following three pronged
%research strategy:

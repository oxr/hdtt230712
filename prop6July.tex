...
{\bf The Project.} Such systems have
...
structure) and extensional reasoning (interchangeability of programs
with the same behaviour). This reflects an even more
fundamental problem --- we lack a satisfactory computational theory of
equality.  {\em Homotopy Type Theory} (HoTT) is widely regarded as
being a breakthrough capable of solving these 
and other problems. We will use HoTT to transform the foundations of software
